...
"""    
		if song is in country genre df, add ‘Country’ to ‘Genre’ column
"""        
	for index_pop in df_pop
"""    
		if song is in pop genre df, add “Pop” to “Genre” column
"""
	for index_hipHopRap in df_hipHopRap 
"""    
if song is in hip-hop/rap genre df, add “Hip-Hop/Rap” to “Genre” column
"""
